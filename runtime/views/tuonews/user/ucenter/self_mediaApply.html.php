                ...
                <div class="user_right_content user_right_content_form">
                    ...
                    <form class="module_form mediaApply" id="content_add_form" action="">
                        <div class="input_wrap clearfix">
                            <label class="input_head fl" ><span class="red_star">*</span>自媒体logo:</label>
                            <p>提示：上传图片时双击裁剪框可以对图片进行裁剪， 建议图片的宽高比例为218x128，否则图片会被压缩</p>
                            <div class="fl">
                                <input type="hidden" name="data[logo]" id="media_logo" tip-text="自媒体logo" required/>
                        ...
                        <div class="input_wrap">
                            ...
                            <textarea class="textarea m_textarea" name="data[help_txt]" tip-text="辅助材料" max-length="300" required></textarea>
                            <p class="tips" style="text-align: left; padding-left: 160px;">0~300个字，请提供您本人的专栏、博客或微信公众号等信息，我们会以您提供的文章做为参考依据，审核您申请的帐号。</p>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <p class="tips" style="text-align: left; padding-left: 160px;">60个字以内，支持中英文和数字</p>
                        </div>
                        <div class="input_nohead_wrap">
