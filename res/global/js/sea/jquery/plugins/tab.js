...
define(function(require, exports, module) {
    ...
    $.fn.tab = function(options){
        ...
        tab.config = {};
        tab.timer = null;
        tab.menu = tab.plugin.find(".tab_menu");
        tab.menuItem = tab.menu.find("li");
        tab.len = tab.menuItem.length;
        tab.content = tab.plugin.find(".tab_content");
        tab.con = tab.content.find(".tab_con");
        tab.conItem = tab.con.find(".tab_conItem");
        ...
        var initAffair = function(){
            ...
            if(trigger == "click" || trigger == "focus"){
                tab.menu.on(trigger, "li", function(){
                    var nextItem = $(this);
                    patterns[effects](nextItem);
                });
            }else if(trigger == "mouseenter"){
                tab.menu.on("mouseenter","li", function(){
                    var nextItem = $(this);
                ...
                tab.menu.on("mouseleave","li", function(){
