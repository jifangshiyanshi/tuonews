<!--list start-->
<section class="article_list small_img_list">
    <!--注意和首页的图片大小不一样
    牛眼 牛头 牛推 620x290  class="article_list"
            ...
            <div class="img_box">
                <a href="<?php echo url("/article_article_detail/?id=$value[id]") ?>">
                    <img class="lazy" src="<?php echo $appConfigs[image_block]?>"
                         data-original="<?php echo getImageThumb($value[thumb], '180x126') ?>" alt="<?php echo $value[title]?>"/>
                </a>
            </div>
            <div class="text_box">
                <h1 class="head"><a href="<?php echo $value[url]?>"><?php echo $value[title]?></a></h1>
                <div class="info">
                    <div class="tag">
                    ...
                    <span class="date"><?php echo $this->getDate($value[add_time], " m-d H:i") ?></span>
