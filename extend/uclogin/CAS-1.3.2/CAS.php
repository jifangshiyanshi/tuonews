...
class phpCAS
{
     ...
     * @var boolean
     */
    private static $_PHPCAS_USE_HTTPS = true;
    ...
    public static function client($server_version, $server_hostname,
        ...
        //设置是否使用安全协议，由blueyb.java@gmail.com添加
        self::$_PHPCAS_CLIENT->useHttps(self::getUseHttps());
        //End 2014-04-09
        phpCAS :: traceEnd();
    }
    ...
    */
     ...
     * @param boolean $use
     */
    public static function setUseHttps($use){
    	self::$_PHPCAS_USE_HTTPS = $use;
    }
     ...
     * @return boolean
     */
    public static function getUseHttps(){
    	return self::$_PHPCAS_USE_HTTPS;
    }
}
