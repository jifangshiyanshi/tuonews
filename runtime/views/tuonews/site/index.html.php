        ...
        <div class="clearfix">
                ...
                <!-- 新闻轮播 -->
                    ...
                    <section class="banner">
                        <div class="sliderBox">
                            ...
                            <!--620x348-->
                            <ul class="slider">
                                <?php foreach ( $casoulItems as $value ) { ?>
                                <li>
                                    <a href="<?php echo url("/site_index_detail/?id=$value[id]&media_id=$loginMedia[id]") ?>">
                    ...
                    <ul class="n-list">
                        ...
                        <li>
                            ...
                            <div class="nl-text">
                                ...
                                <div class="nl-brief">
                                    <p><?php echo $this->cutString($value['bcontent'], " 75 '...'") ?><a href="<?php echo url("/site_index_detail/?id=$value[id]&media_id=$loginMedia[id]") ?>">[详细]</a></p>
                                </div>
                                <div class="nl-relate">
            ...
            <div class="r-con fr">
                <div class="r-box">
                    ...
                    <div class="r-hot-box">
                        <ul class="r-hot-con">
                            <?php foreach ( $hotArticles as $value ) { ?>
                            <li>
                                <div class="h-photo">
                                    <a href="<?php echo url("/site_index_detail/?id=$value[id]&media_id=$loginMedia[id]") ?>">
                                        <img alt="<?php echo $value['title']?>" src="<?php echo $value['thumb']?>" /></a>
                                </div>
                                <div class="h-text">
                                    <h3><a href="<?php echo url("/site_index_detail/?id=$value[id]&media_id=$loginMedia[id]") ?>"><?php echo $this->cutString($value[title], " 18 '...'") ?></a></h3>
                                    <div class="h-relate">
                                        <span class="h-read">阅读：(&nbsp;<i><?php echo $value['hits']?></i>&nbsp;)</span>
                                        <!--<span class="h-author"><?php echo $value[author]?></span>-->
                                    </div>
                                </div>
                            </li>
                            <?php } ?>
