...
use common\service\interfaces\IACommonService;
use herosphp\core\Loader;

Loader::import('common.service.interfaces.IACommonService', IMPORT_APP);
/**
 * 通用服务接口实现
 * Class CommonService
 * @package common\service
 */
abstract class ACommonService implements IACommonService {
