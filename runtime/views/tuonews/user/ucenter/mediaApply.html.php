                ...
                <div class="user_right_content user_right_content_form">
                    ...
                    <form class="module_form mediaApply" id="content_add_form" action="">
                        <div class="input_wrap clearfix">
                            <label class="input_head fl" ><span class="red_star">*</span>媒体logo:</label>
                            <p>提示：上传图片时双击裁剪框可以对图片进行裁剪， 建议图片的宽高比例为218x128，否则图片会被压缩</p>
                            <div class="fl">
                                <input type="hidden" name="data[logo]" id="media_logo" tip-text="媒体logo" required/>
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" class="input m3_input" name="data[company_code]" tip-text="组织机构代码" required/>
                            <span class="tips">请填写组织机构代码</span>
                        </div>
                        <div class="input_wrap">
                            <label class="input_head" ><span class="red_star">*</span>组织机构代码扫描件：</label>
                            <img src="<?php echo $appConfigs[default_logo]?>" id="company-previw" tip-text="组织机构代码扫描件" required/>
                        </div>
                        <div class="input_tips_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" class="input m3_input" name="data[telephone]" dtype="phone" tip-text="固定电话" required/>
                            <span class="tips">例如：0769-38998777</span>
                        </div>
                        <div class="input_wrap">
